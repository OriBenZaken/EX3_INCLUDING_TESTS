...
header, but your ThreadArgs are not. This way, you can fully test your internal
implementation without leaking it to your ThreadArgs.
...
class, which is then declared in a `*-internal.h` file. Your ThreadArgs aren't
